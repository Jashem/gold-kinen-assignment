...
class __$$_FetchedCopyWithImpl<$Res>
    extends _$PostsEventCopyWithImpl<$Res, _$_Fetched>
...
class _$_Fetched implements _Fetched {
  ...
  @override
  String toString() {
    return 'PostsEvent.fetched(userId: $userId)';
  }
...
abstract class _Fetched implements PostsEvent {
  const factory _Fetched(final int userId) = _$_Fetched;
